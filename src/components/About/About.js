      ...
      <div className="we-are-block">
        <div id="about-us-section">
          ...
          <div className="about-us-info">
            ...
            <a href="https://www.ted.com/about/programs-initiatives/tedx-program" title="About Us Button">Explore TEDx </a>
          </div>
        </div>
        <div id="history-section">
          ...
          <div className="history-info">
            ...
            <a href="https://www.youtube.com/@tedxiitgandhinagar/videos" title="History Button">Last Year Lineup</a>
          </div>
        </div>
        </div>
    </>
